...
export const Contain = styled(Button)`
  ...
  color: ${({ theme, selected }) =>
    selected
      ...
      : theme.color.grayScale.coolGray500};
  ...
  background: ${({ theme, selected }) =>
    selected ? theme.color.primary.blue500 : "none"};
  border: 2px solid
    ${({ theme, selected }) =>
      selected
        ? theme.color.primary.blue500
        : theme.color.grayScale.coolGray200};
  border-radius: 20px;

  &:hover {
    color: ${({ theme, selected }) =>
      !selected && theme.color.grayScale.basic.black};
    background: ${({ theme, selected }) =>
      selected
        ? theme.color.grayScale.coolGray500
        : theme.color.grayScale.coolGray200};
...
export const Vertical = styled(Button)`
  ...
  color: ${({ theme, selected }) =>
    selected
      ? theme.color.grayScale.basic.black
      : theme.color.grayScale.coolGray700};
